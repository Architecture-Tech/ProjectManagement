												...
												<div className="space-y-4 md:space-y-6" action="#">
													...
													<div>
														...
														<input type="password"
															...
															name="password" id="password" className="bg-gray-50 outline-none border-[1px] border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-[rgb(33,33,33)] dark:placeholder-gray-400 dark:text-white focus:ring-blue-500 focus:border-blue-500 dark:focus:border-[#4f4f4f] dark:border-[#303030]" required="" />
													</div>
