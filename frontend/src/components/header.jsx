...
import logo from '../assets/architecture-tech-kogo.webp'
...
const Header = () => {
  ...
  return (
    <div className=" fixed w-full z-[99] bg-[rgb(36,35,35)] dark:bg-[rgb(18,18,18)] transition-all py-1 sm:py-2 md:py-3 flex items-center justify-between shadow-md dark:bg-[#000000]">
      <div className="flex items-center justify-between w-full max-w-[1750px] px-4 mx-auto sm:px-6 md:px-8">
        <div className="flex justify-center items-center gap-2">
          ...
          <span onClick={() => {
            navigate(isLogged ? '/bounties' : '/bounties')
          }} className=' no-underline text-white transition-all'><p className=' cursor-pointer text-[24px] font-bold mt-[7px]'>Project Management v2.0</p></span>
        </div>
        <nav className="flex-wrap gap-3 items-center hidden space-x-4 pc-menu md:flex">
          ...
          <div className=" flex gap-[7px] justify-center items-center">
            ...
            {/* {
                              ...
                              : <img className="w-8 h-8 rounded-[50%]" src="./images/user.jpg" alt="" />
                            } */}
              ...
              <div className="mt-[5px]">
                <Menu.Button className="inline-flex w-full justify-center rounded-[50px] text-sm font-semibold text-gray-900 dark:text-[white] shadow-sm ring-1 ring-inset ring-gray-300">
                  ...
                  >
                    ...
                    <img className='header-user' src={(user.avatar === 'default' || !user.avatar) ? '/images/user.jpg' : `${process.env.REACT_APP_API_BASE_URL}/${user.avatar}`} alt="" />
              ...
              <div className="mt-[5px]">
                <Menu.Button className="inline-flex w-full justify-center rounded-[50px] text-sm font-semibold text-gray-900 dark:text-[white] shadow-sm ring-1 ring-inset ring-gray-300">
                  ...
                  >
                    ...
                    <img className='header-user' src={'/images/user.jpg'} alt="" />
